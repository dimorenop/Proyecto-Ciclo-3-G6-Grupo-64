...
public class VacupetApplication {

	private final ApplicationContext applicationContext;

	@Autowired
	public VacupetApplication(ApplicationContext applicationContext) {
	...
	public static void main(String[] args) {
		SpringApplication.run(VacupetApplication.class, args);
	}
